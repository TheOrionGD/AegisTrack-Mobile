...
def send_sms_message(phone_number, message, owner=None):
    ...
    sms_sender = os.getenv('SMS_SENDER', tw_from or 'MTS')
              ...
              <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  <td align="left" style="color: #ffffff; font-size: 16px; font-weight: 700; font-family: sans-serif;">
                    <span style="letter-spacing: 1px;">MTS CORE TRACKER</span>
                  </td>
          ...
          <tr style="background-color: #f3f6f8; border-top: 1px solid #e1e9ee;">
            <td style="padding: 32px 32px 24px 32px; text-align: center; font-size: 12px; color: #66788a; line-height: 18px;">
              ...
              <p style="margin: 0 0 24px 0;">
                This email was generated by <strong>MTS CORE TRACKER</strong>.<br>
...
def send_html_email_via_smtp(to_email, subject, html_content):
    ...
    smtp_from = os.getenv('SMTP_FROM', 'MTS Core Tracker <godfrey.cs23@krct.ac.in>')
    ...
    try:
        ...
        plain_text = (
            "MTS CORE TRACKER - Device Monitoring Authorization Request\n\n"
...
def create_tracking_request():
    ...
    try:
        subject = quote_plus(f"MTS CORE TRACKER: Consent Request for {owner_name}")
